...
import br.com.thiago.helpdesk.domain.dtos.ClienteDTO;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		if (obj.getChamados().size() > 0) {
			throw new DataIntegrityViolationException("Cliente possui "+ obj.getChamados().size() +" ordem(s) de serviço e não pode ser deletado!");
		}
